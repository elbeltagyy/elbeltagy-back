...
const { sendWhatsMsg } = require("../tools/sendWhats.js");
...
const forgetPassword = asyncHandler(async (req, res, next) => {
    ...
    try {
        ...
        if (forgetMethod === senderConstants.WHATSAPP) {
            ...
            await sendWhatsMsg(user.phone, message)
        ...
        await user.save();
        console.log('error from forget password==> ', err)
        return next(createError("حدث خطا اثناء ارسال الايميل", 500, statusTexts.FAILED));
    }
})
